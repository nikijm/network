 ...
 * @author fangwei
 * @date 2017年5月15日 下午3:25:26
 *
 */
public class DesUtils {

    private static String key2 = "www.jk.com";

    private static String key3 = "t#bbc!.cn@989";
     ...
     * @Description: des加密
     * @author fangwei
     * @date 2017年5月15日 下午3:24:32
     * @param data
     * @param key
     * @return
     */
    public static String encoded(String data, String key) {
        return strEnc(data, key, key2, key3);
    }
     ...
     * @Description: des解密
     * @author fangwei
     * @date 2017年5月15日 下午3:24:45
     * @param data
     * @param key
     * @return
     */
    public static String decoded(String data, String key) {
        return strDec(data, key, key2, key3);
    }

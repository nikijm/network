...
public interface IConvertService {
	...
	void doConvert(DataFile dataFile) throws DataException;
	
	void convertFlow(DataTable table,List<Integer> successIds,List<Integer> failedIds,String tableName) throws DataException;

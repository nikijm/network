...
import com.jk.ndtetl.mon.dao.AlarmRuleDao;
...
public class AlarmRuleServiceImpl implements AlarmRuleService {
    ...
    public AlarmRuleBean getAlarmRuleById(Integer alarmRuleId) {
        ...
        if (alarmRuleBean.getExpressionType() != null && alarmRuleBean.getExpression() != null) {
    ...
    private void updateRule(AlarmRuleBean alarmRuleBean, Integer[] machineType) {
        ...
        logManagerService.info("对规则进行了修改");
    }
    ...
    public void deleteAlarmRule(Integer id) {
        ...
        logManagerService.info("对规则进行了删除");
    }

    @Override
    public void deleteAlarmRuleByServerId(AlarmRuleBean alarmRuleBean) {
        alarmRuleDao.deleteAlarmRuleByServerId(alarmRuleBean);
    }

    @Override
    public void insertBusinessAlarmLogs(AlarmLogs alarmLogs) {
        alarmRuleDao.insertBusinessAlarmLogs(alarmLogs);
    }
}

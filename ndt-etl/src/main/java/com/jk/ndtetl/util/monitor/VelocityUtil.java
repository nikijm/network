...
public class VelocityUtil {
	...
	public static String getBusinessContent(){
		String content = "<div class='title'>$!{title}</div>"+
				  "<div class='subtitle'>$!{now}</div>"+
				  "<div class='subtitle'>模块：$!{resource}</div>"+
				  "<div class='subtitle'>报警内容：$!{content}</div>";
		return content;
	}
	...
	public static Map<String, Object> getDataMap(String title,String module,String hostname,String IPAddress,String content){
		 String dateToString = DateUtils.getDateToString(new Date());
		 Map<String, Object> map = new HashMap<String, Object>();
	     map.put("title", title);
	     map.put("now", dateToString);
	...
	public static Map<String, Object> getBusinessMap(String title,String resource,String content){
		 String dateToString = DateUtils.getDateToString(new Date());
		 Map<String, Object> map = new HashMap<String, Object>();
	     map.put("title", title);
	     map.put("now", dateToString);

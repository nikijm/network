...
public class CleanController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/cleans",method = RequestMethod.GET)
    @ResponseBody
    public Object listCacheDataFiles(HttpServletRequest request, Integer orgId, Integer etlBusinessTypeId, BasePage basePage){
        ...
        TableDef tableDef = iTableDefService.getTableByCategoryAndBusinessType(TableDef.CATEGORY_CLEAN, etlBusinessTypeId);
